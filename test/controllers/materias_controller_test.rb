...
class MateriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materia" do
    assert_difference("Materia.count") do
      post materias_url, params: { materia: { colegio_id: @materia.colegio_id, nombre: @materia.nombre, profesor_id: @materia.profesor_id } }
    end
  ...
  test "should update materia" do
    patch materia_url(@materia), params: { materia: { colegio_id: @materia.colegio_id, nombre: @materia.nombre, profesor_id: @materia.profesor_id } }
