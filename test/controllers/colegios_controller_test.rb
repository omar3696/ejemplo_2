...
class ColegiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colegio" do
    assert_difference("Colegio.count") do
      post colegios_url, params: { colegio: { direccion: @colegio.direccion, nombre: @colegio.nombre } }
    end
  ...
  test "should update colegio" do
    patch colegio_url(@colegio), params: { colegio: { direccion: @colegio.direccion, nombre: @colegio.nombre } }
